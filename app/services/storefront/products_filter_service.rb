module Storefront
  class ProductsFilterService
    ...
    def call
      ...
      searched = filter_records.select("products.*, games.developer, games.release_date").distinct
    ...
    def set_pagination_attributes(total_filterd)
      total_pages = (total_filterd / @params[:length].to_f).ceil
      @pagination.merge!(page: @params[:page], length: @records.size, total: total_filterd, total_pages: total_pages)
    end
